...
import cn.edu.jmu.jyf.bean.Administrator;
 ...
 * 
 * @see cn.edu.jmu.jyf.bean.Administrator
...
public class AdministratorDAO {
	...
	public Administrator findById(java.lang.Integer id) {
		...
		try {
			Administrator instance = (Administrator) getCurrentSession().get(
					"cn.edu.jmu.jyf.bean.Administrator", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Administrator> findByExample(Administrator instance) {
		...
		try {
			List<Administrator> results = (List<Administrator>) getCurrentSession()
					.createCriteria("cn.edu.jmu.jyf.bean.Administrator")
	...
	public List<Administrator> findByLoginName(Object loginName) {
		return findByProperty(LOGIN_NAME, loginName);
	}

	public List<Administrator> findByPasswordHash(Object passwordHash) {
		return findByProperty(PASSWORD_HASH, passwordHash);
	}

	public List<Administrator> findByName(Object name) {
		return findByProperty(NAME, name);
	}

	public List<Administrator> findByToken(Object token) {
