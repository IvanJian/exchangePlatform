...
public class UserDAO {
	...
	public List<User> findByExample(User instance) {
		...
		try {
			List<User> results = (List<User>) getCurrentSession()
					.createCriteria("cn.edu.jmu.jyf.bean.User")
	...
	public List<User> findByPasswordHash(Object passwordHash) {
	...
	public List<User> findByIsBanned(Object isBanned) {
		return findByProperty(IS_BANNED, isBanned);
	}

	public List<User> findByToken(Object token) {
		return findByProperty(TOKEN, token);
	}

	public List<User> findByIcon(Object icon) {
		return findByProperty(ICON, icon);
	}

	public List<User> findByIntroduction(Object introduction) {
